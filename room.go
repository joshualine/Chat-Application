...
type room struct {
	forward chan []byte      // "forward" is a channel that holds incomming messages that should be forwarded to the other clients.
	...
	clients map[*client]bool // "clients" holds current clients in this room.
}
